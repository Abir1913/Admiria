...
">____Best Sellers____</p>
    ...
    <div class="row">
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">NARS pallete</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">Chanel Remover</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">Maybelline Highlighter</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">Huda Beauty Foundation</a></p>
        ...
        <div class="rightcolumn">
            <div class="card">
                <h1>Beauty Tips</h1>
                <img src="photos/model.jpg" style="height: 300px;width: 100%">
...
">____Trending____</p>
    ...
    <div class="row">
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">L'OREAL eyes</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">MAC_brush</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">Gucci_lips</a></p>
        ...
        <div class="leftcolumn">
            ...
            <p><a href="#" style="font-size: 16px;font-family: 'Fira Code Retina'">L'OREAL remover</a></p>
    ...
    <p style="color: white">hello</p>
    <div class="container">
        <img src="adf.jpg" alt="Avatar" style="width:90px">
        <p style="font-size: 17px">Adnan Firoze-</p>
        <p style="font-size: 15px">"Excellent experience....."</p>
    </div>

    <div class="container">
        <img src="photos/fatimah.jpg" alt="Avatar" style="width:70px">
        <p style="font-size: 17px">Fatimah Zahra-</p>
